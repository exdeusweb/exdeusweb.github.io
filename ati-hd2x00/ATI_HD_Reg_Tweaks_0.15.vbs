...
' performance of ATI HD2000, HD3000, & HD4000 series video cards 
' for use in HTPCs. 
'
' Double-click to run.
'
...
If success Then
	...
	result = MsgBox("Do you have the ATI HD2400 video card?" & vbCrLf & vbCrLf & "Answer 'No' for the ATI HD2600, HD3000, or HD4000 series.",_
